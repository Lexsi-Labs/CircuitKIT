"""Benchmark: all 9 algorithms on GPT-2 + IOI.

Real model, real task, no mocks. For each algorithm runs discover_circuit
followed by evaluate_circuit (Pillar-1 patching + Pillar-2 ablation) and
records discovery wall time, eval wall time, and the two pillar scores.
"""
...
def main() -> int:
    ...
    for algo in ALL_ALGOS:
        # Smaller num_examples for the slower algos to keep total wall reasonable.
