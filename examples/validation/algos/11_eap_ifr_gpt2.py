"""Validation: EAP-IFR (Information Flow Routes) on GPT-2 IOI.

EAP-IFR follows the per-position information-flow-route formulation:
edges are scored by how much information flows along them rather than
by gradient × activation alone. Reuses the EAP-CSV path and node-level
output. End-to-end real-model run. No mocks.
"""
