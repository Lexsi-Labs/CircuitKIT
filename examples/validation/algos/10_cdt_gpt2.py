"""Validation: CD-T (Contextual Decomposition for Transformers) on GPT-2 IOI.

CD-T decomposes each layer's output into a (relevant, irrelevant) tuple
by routing the target token through the model and tracking what
contribution flows from each component. Non-EAP method — no clean/
corrupt counterfactual required.
