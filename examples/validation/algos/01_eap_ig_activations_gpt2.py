"""Validation: top-level algorithm key 'eap-ig-activations' on GPT-2 IOI.

Promoted in this session from `discovery.method='EAP-IG-activations'`
(EAP-IG attribution computed at the activation level rather than the input
level). End-to-end real-model run. No mocks.
"""
...
SCRIPT_NAME = "01_eap_ig_activations_gpt2"
ALGO = "eap-ig-activations"
...
def main() -> int:
    ...
    try:
        result = run_algo(ALGO, num_examples=32, ig_steps=2)
    ...
    status = {
        ...
        "input": {
            ...
            "algorithm": ALGO, "num_examples": 32, "ig_steps": 2,
        },
        "output": {
