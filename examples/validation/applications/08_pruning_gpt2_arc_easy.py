"""Application: structural pruning on GPT-2 / arc_easy for every algorithm.

Pruning preserves ARC-Easy MCQ via NormalizedTaskSpec.
...
SCRIPT_NAME = "08_pruning_gpt2_arc_easy"
MODEL = "gpt2"
TASK = "arc_easy"
