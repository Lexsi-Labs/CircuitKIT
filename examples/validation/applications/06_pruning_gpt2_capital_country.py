"""Application: structural pruning on GPT-2 / capital_country for every algorithm.

Pruning preserves capital-country factual recall.
...
SCRIPT_NAME = "06_pruning_gpt2_capital_country"
MODEL = "gpt2"
