"""Application: structural pruning on GPT-2 / crows_pairs for every algorithm.

Pruning preserves CrowS-Pairs bias detection.
...
SCRIPT_NAME = "10_pruning_gpt2_crows_pairs"
MODEL = "gpt2"
TASK = "crows_pairs"
