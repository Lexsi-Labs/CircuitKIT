"""EAP-GP selector — GradPath adaptive integration path."""
import torch
import logging
...
@register("eap-gp")
def eap_gp_selector(model, task_name: str, config: dict) -> dict:
    """Run EAP-GP attribution on an already-loaded HookedTransformer."""
